...
export default function MeteorologicalDriftChartLoader({setTypeData, setIsFetched}:
    {setTypeData: React.Dispatch<React.SetStateAction<IMeteorologicalDriftData[]>>,
