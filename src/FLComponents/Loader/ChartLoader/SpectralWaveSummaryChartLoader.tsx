...
export default function SpectralWaveSummaryChartLoader({setTypeData, setIsFetched}:
    {setTypeData: React.Dispatch<React.SetStateAction<IWaveSummaryData[]>>,
    ...
    const fetchData = useCallback(async () => {
        const res = await fetch('/api/getSPEC/', {
            method: "POST",
            headers: {
        ...
        if (!res.ok)
            ...
            const data: IWaveSummaryData[] = await res.json();
            setTypeData(data);
        }
