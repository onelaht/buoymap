...
export default function HourlyRainChartLoader({setTypeData, setIsFetched}:
    {setTypeData: React.Dispatch<React.SetStateAction<IHourlyRainData[]>>,
    ...
    const fetchData = useCallback(async () => {
        const res = await fetch('/api/getRAIN/', {
            method: "POST",
            headers: {
        ...
        if (!res.ok)
            ...
            const data: IHourlyRainData[] = await res.json();
            setTypeData(data);
        }
