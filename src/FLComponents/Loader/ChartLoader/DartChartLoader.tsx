...
export default function DartChartLoader({setTypeData, setIsFetched}:
    {setTypeData: React.Dispatch<React.SetStateAction<IDartData[]>>,
    ...
    const fetchData = useCallback(async () => {
        const res = await fetch('/api/getDART/', {
            method: "POST",
            headers: {
        ...
        if (!res.ok)
            ...
            const data: IDartData[] = await res.json();
            setTypeData(data);
        }
